...
describe("duplication form page", () => {
  ...
  test("renders values from the visit being duplicated", async () => {
    ...
    const expectedFormValues = {
      ...
      heightCm: visit.probandInfo.heightCm.toString(),
      weightKg: visit.probandInfo.weightKg.toString(),
      visualCorrection: "form.enums.visualCorrection.NO",
      visualCorrectionDioptre: visit.probandInfo.visualCorrectionDioptre.toString(),
